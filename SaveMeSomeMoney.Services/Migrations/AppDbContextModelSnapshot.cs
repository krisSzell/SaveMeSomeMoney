...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaveMeSomeMoney.Services.Models.Expense", b =>
                {
                    ...
                    b.Property<int?>("ExpenseCategoryId1");

                    b.Property<decimal>("Value");

                    b.HasKey("Id");

                    b.HasIndex("ExpenseCategoryId1");
            ...
            modelBuilder.Entity("SaveMeSomeMoney.Services.Models.Income", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SaveMeSomeMoney.Services.Models.Expense", b =>
                {
                    b.HasOne("SaveMeSomeMoney.Services.Models.ExpenseCategory", "ExpenseCategory")
                        .WithMany("Expenses")
                        .HasForeignKey("ExpenseCategoryId1");
                });
